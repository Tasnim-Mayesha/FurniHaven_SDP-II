...
class Nagad extends StatefulWidget {
  ...
  @override
  _NagadState createState() => _NagadState();
}
...
class _NagadState extends State<Nagad> {
  ...
  Future<void> _loadCredentials() async {
    ...
    String? phoneNumber = prefs.getString('nagadPhoneNumber');
    String? pin = prefs.getString('nagadPin');
  ...
  Future<void> _saveCredentials(String phoneNumber, String pin) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    await prefs.setString('nagadPhoneNumber', phoneNumber);
    await prefs.setString('nagadPin', pin);
  }
                ...
                child: CustomButton(
                  ...
                  onTap: () async {
                    ...
                    if (phone.isNotEmpty && pin.isNotEmpty) {
                      ...
                      await _addOrderToFirestore(cartItems, 'Nagad', totalCost, selectedAddress);
